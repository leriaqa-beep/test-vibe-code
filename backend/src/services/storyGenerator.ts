...
- Появление героя-помощника — он приходит мягко, ненавязчиво
- ГЛАВНАЯ ЧАСТЬ (самая длинная!) — герой ОТВЕЧАЕТ на вопрос через волшебную метафору или мини-историю внутри истории. Это развёрнутое, тёплое объяснение в 3-5 абзацев с диалогами. Ребёнок задаёт уточняющие вопросы, герой отвечает. Объяснение должно быть научно верным, но подано через сказочные образы.
...
РОД ГЕРОЯ-ПОМОЩНИКА определяй по имени:
- Кот, Дракон, Лев, Единорог — мужской род (он, его, рассказал, сказал, пришёл)
