...
— Минимум 2 сенсорных детали (мягкий, тёплый, щекотно, пахнет, блестит, шуршит)
— Минимум 1 восклицание ребёнка или героя ("Ого!", "Вот это да!", "Правда?!")
— Объяснение через ДЕЙСТВИЕ или маленькую сценку — не через факт
— Повтор-усиление: одна фраза или образ повторяется дважды для запоминания

ЗАПРЕЩЕНО:
— Писать подряд: "X сделал. Y сказал. Z улыбнулась." — это протокол, не сказка
— Использовать одно и то же слово эмоции дважды подряд ("улыбнулась... тоже улыбнулась")
— Объяснять факт напрямую ("задние лапки сильные") — только через образ или показ`,
