...
ПРАВИЛЬНО (вдохновляться, не копировать): "Вдруг за кустом что-то зашуршало — тихо-тихо. Потом мелькнул рыжий хвост. И тут из-за дерева вышел Кот Бартлби — мягкий, пушистый, с добрыми глазами."
...
ЗАПРЕЩЕНО: "Задние лапки сильные. Они помогают бежать." — это факт без жизни.
ПРАВИЛЬНО: герой ПОКАЗЫВАЕТ или рассказывает маленькую историю: "Кот Бартлби присел и оттолкнулся задними лапками — раз! — и прыгнул высоко-высоко. «Видишь?» — мурлыкнул он. «Вот для чего они нужны — чтобы прыгать к облакам!»"
