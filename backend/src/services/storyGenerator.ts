...
- Появление УКАЗАННОГО героя-помощника — он появляется ПОДГОТОВЛЕННО: сначала намёк (звук, тень, голос), затем сам герой. НИКОГДА не пиши "[Имя героя] пришёл." без предшествующей подготовки. Пример: "Вдруг за кустом что-то зашуршало. Потом послышался знакомый голос..." / "Из-за поворота выехал..."
