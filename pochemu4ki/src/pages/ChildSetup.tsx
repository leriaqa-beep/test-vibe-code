...
export default function ChildSetup() {
  ...
  // Declined name variants (available once name is entered)
      ...
      <div className="max-w-lg mx-auto px-4 py-8 relative">
        ...
        {step === 1 && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            <h2 className="text-2xl font-bold text-gray-900 mb-1">Как зовут вашего ребёнка?</h2>
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          {step < TOTAL_STEPS ? (
            ...
            <button
              ...
              className="bg-purple-600 text-white font-semibold py-3 px-8 rounded-xl shadow-sm hover:bg-purple-700 disabled:opacity-40 transition flex items-center gap-2"
            >
              {saving ? 'Создаём...' : 'Создать профиль'} <Check className="w-4 h-4" />
            </button>
          )}
        </div>
